...
// 读取旧版本 (101篇)
const oldFile = fs.readFileSync(path.join(__dirname, 'temp-101-articles.ts'), 'utf8');
...
// 读取新版本 (105篇)
const newFile = fs.readFileSync(path.join(__dirname, 'src', 'data', 'staticData.ts'), 'utf8');
